...
from transforms import sample_images,RandomHorizontalFlip, Resize, Normalize, Crop, RandomTranspose, RandomVerticalFlip
...
def main(args):
    ...
    generator = STRNet(3)
    params_info = paddle.summary(generator, (1,3,256,256))
    print(params_info)
    if args.pretrained != '':
    ...
    G_optimizer = paddle.optimizer.AdamW(learning_rate=0.0001, 
